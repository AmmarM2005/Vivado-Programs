...
REM
REM Generated by Vivado on Mon Nov 24 11:16:52 +0530 2025
...
echo "xvlog --incr --relax -prj SD_4bit_Mealy_vlog.prj"
call xvlog  --incr --relax -prj SD_4bit_Mealy_vlog.prj -log xvlog.log
