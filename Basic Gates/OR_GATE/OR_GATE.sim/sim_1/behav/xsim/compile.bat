...
REM
REM Generated by Vivado on Sat Oct 11 22:52:39 +0530 2025
...
echo "xvlog --incr --relax -prj or_gate_gatelevel_vlog.prj"
call xvlog  --incr --relax -prj or_gate_gatelevel_vlog.prj -log xvlog.log
