...
REM
REM Generated by Vivado on Mon Oct 27 15:39:16 +0530 2025
...
echo "xvlog --incr --relax -prj adder_8bit_vlog.prj"
call xvlog  --incr --relax -prj adder_8bit_vlog.prj -log xvlog.log
