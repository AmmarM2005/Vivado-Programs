...
REM
REM Generated by Vivado on Sat Nov 01 12:24:01 +0530 2025
...
echo "xvlog --incr --relax -prj ALU_8_bit_tb_vlog.prj"
call xvlog  --incr --relax -prj ALU_8_bit_tb_vlog.prj -log xvlog.log
