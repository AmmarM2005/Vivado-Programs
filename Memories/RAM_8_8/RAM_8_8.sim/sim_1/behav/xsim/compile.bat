...
REM
REM Generated by Vivado on Mon Nov 24 11:20:07 +0530 2025
...
echo "xvlog --incr --relax -prj RAM_8_8_vlog.prj"
call xvlog  --incr --relax -prj RAM_8_8_vlog.prj -log xvlog.log
