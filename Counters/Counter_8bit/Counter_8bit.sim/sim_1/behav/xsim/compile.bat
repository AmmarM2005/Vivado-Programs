...
REM
REM Generated by Vivado on Mon Nov 24 10:57:45 +0530 2025
...
echo "xvlog --incr --relax -prj Counter_8bit_vlog.prj"
call xvlog  --incr --relax -prj Counter_8bit_vlog.prj -log xvlog.log
