...
REM
REM Generated by Vivado on Sun Nov 23 16:57:21 +0530 2025
...
echo "xvlog --incr --relax -prj FF_JK_vlog.prj"
call xvlog  --incr --relax -prj FF_JK_vlog.prj -log xvlog.log
