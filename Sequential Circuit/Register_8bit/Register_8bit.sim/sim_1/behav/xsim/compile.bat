...
REM
REM Generated by Vivado on Sun Nov 23 17:42:20 +0530 2025
...
echo "xvlog --incr --relax -prj usr_8bit_vlog.prj"
call xvlog  --incr --relax -prj usr_8bit_vlog.prj -log xvlog.log
